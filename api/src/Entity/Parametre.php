...
class Parametre
{
    ...
    public function getMaxEquipes(): ?int { return $this->max_equipes; }
    public function setMaxEquipes(int $max_equipes): static { $this->max_equipes = $max_equipes; return $this; }
    ...
    public function getNbSurfaces(): ?int { return $this->nb_surfaces; }
    public function setNbSurfaces(int $nb_surfaces): static { $this->nb_surfaces = $nb_surfaces; return $this; }
